...
const Payment = () => {
  ...
  return (
    <div className="my-5 min-h-screen gap-5 flex flex-col w-full justify-center items-center">
      <Link to="/" className="btn btn-wide btn-warning">
        Back To Home
      </Link>
      <div className="flex flex-col gap-5 min-h-screen justify-around w-full lg:w-3/4 items-center lg:flex-row">
        <div className="w-full lg:w-1/2 md:w-3/4 lg:p-5 gap-5 flex flex-col justify-center items-center">
        ...
        <div className="w-full px-5 lg:w-1/2 md:w-full h-96 mb-10">
          <div className="mb-5 ">
