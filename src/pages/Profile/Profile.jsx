...
const Profile = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-center bg-slate-200 mb-5 min-h-96 py-5 px-10 gap-10">
        ...
        <div className="flex-1 bg-slate-100 h-80 p-4 rounded-lg">
          <div className="flex flex-col bg-white gap-10 p-6 rounded-lg">
            <div>
            ...
            <div className="flex justify-center items-center text-blue-400 text-xl md:text-3xl lg:text-4xl">
              <IoLocationSharp />
